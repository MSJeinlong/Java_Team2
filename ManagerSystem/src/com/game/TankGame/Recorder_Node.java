...
class Recorder {
	...
	public static void readRecords() {
		try {
			fr = new FileReader("/TankGame_Recorder/recorder1.txt");
			...
			// 读取地图信息
			fr1 = new FileReader("/TankGame_Recorder/recorder2.txt");
	...
	public static void savaGame() {
		try {
			// 创建保存数据的文件1
			fw = new FileWriter("/TankGame_Recorder/recorder1.txt");
			...
			// 创建保存数据的文件2,用于保存地图
			fw1 = new FileWriter("/TankGame_Recorder/recorder2.txt");
